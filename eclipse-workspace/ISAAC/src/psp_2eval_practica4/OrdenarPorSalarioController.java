...
public class OrdenarPorSalarioController {
	private ArrayList<Usuario> usuariosADevolver = null;

	public OrdenarPorSalarioController() {
		super();
	}
	...
	private ArrayList<Usuario> get() {
		...
		try {
			...
			respuesta = GestorHTTP.peticion("http://localhost:8080/ProyectoFinalJorgeAlbors/usuarios/ordenarPorDinero",
					"", "GET", "");
