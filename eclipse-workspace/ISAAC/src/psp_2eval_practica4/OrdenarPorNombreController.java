...
public class OrdenarPorNombreController {
	private ArrayList<Usuario> usuariosADevolver = null;

	public OrdenarPorNombreController() {
		super();
	}
	...
	private ArrayList<Usuario> get() {
		...
		try {
			...
			respuesta = GestorHTTP.peticion("http://localhost:8080/ProyectoFinalJorgeAlbors/usuarios/ordenarPorNombre",
					"", "GET", "");
