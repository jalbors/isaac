...
public class OrdenarPorSalario extends javax.swing.JFrame {

	public OrdenarPorSalario() {
		initComponents();
	}
	...
	public static void main(String args[]) {
		try {
			...
			java.util.logging.Logger.getLogger(OrdenarPorSalario.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
